...
namespace Mail
{
    class SystemAudit
    {
        ...
        private static System.Net.Mail.MailMessage[] getMailMessages(ImapClient imapClient)
        {
            IEnumerable<uint> uids = imapClient.Search(SearchCondition.Unseen().And(SearchCondition.From("systemaudit@bit-lever.com")));
        ...
        //        Outlook.Recipient recipBcc = otMsg.Recipients.Add("recruiting@statesidebpo.com");
